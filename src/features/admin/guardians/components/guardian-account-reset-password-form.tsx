...
type ResetPasswordAction = (
  state: GuardianAccountResetPasswordActionState,
  formData: FormData,
) => Promise<GuardianAccountResetPasswordActionState>;

type GuardianAccountResetPasswordFormProps = {
...
export function GuardianAccountResetPasswordForm({
  action,
  initialState,
  cancelHref,
  guardianName,
  loginId,
}: GuardianAccountResetPasswordFormProps) {
    ...
    >
      ...
      <section className="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-4">
        ...
        <p className="mt-2 text-xs leading-5 text-amber-700">
          Setelah perubahan disimpan, wali harus
          menggunakan password baru untuk proses
          login berikutnya.
        </p>
      </section>
