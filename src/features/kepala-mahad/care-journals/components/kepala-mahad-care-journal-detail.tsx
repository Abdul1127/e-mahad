...
import {
  KepalaMahadCareJournalEntryBrowser,
} from "./kepala-mahad-care-journal-entry-browser";
    ...
    <div className="mx-auto w-full max-w-[1480px] px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      ...
      {journal.status ===
        ...
        <section className="mt-5 rounded-2xl border border-blue-200 bg-blue-50 p-4 sm:p-5">
          <p className="font-semibold text-blue-800">
            Jurnal menunggu keputusan review
          </p>

          <p className="mt-1 text-sm leading-6 text-blue-700">
            Gunakan filter kondisi untuk
            menemukan santri yang berbeda
            dari kondisi normal tanpa
            membaca seluruh daftar satu per
            satu.
          </p>
        </section>
      )}
      ...
      {journal.status ===
        ...
        <section className="mt-5 rounded-2xl border border-amber-200 bg-amber-50 p-4 sm:p-5">
          <p className="font-semibold text-amber-800">
            Jurnal sudah dikembalikan untuk revisi
          </p>

          <p className="mt-1 text-sm leading-6 text-amber-700">
            Pengasuh dapat memperbaiki
            jurnal berdasarkan catatan
            review kemudian mengirimkannya
            kembali.
          </p>
        </section>
      )}
      ...
      {journal.status ===
        ...
        <section className="mt-5 rounded-2xl border border-emerald-200 bg-emerald-50 p-4 sm:p-5">
          <p className="font-semibold text-emerald-800">
            Jurnal sudah selesai direview
          </p>

          <p className="mt-1 text-sm leading-6 text-emerald-700">
            Submission ini sudah diperiksa
            oleh Kepala Ma&apos;had.
          </p>
        </section>
      )}
      ...
      <section className="mt-6">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-muted">
          Cari nama santri atau gunakan
          filter kondisi untuk
          memprioritaskan data yang perlu
          diperhatikan.
        </p>
